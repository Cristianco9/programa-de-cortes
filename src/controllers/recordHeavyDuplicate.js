...
export const recordHeavyDuplicate = async (req, res, next) => {
  ...
  try {
    ...
    const anjeoHeavyToDuplicate = {
      ...
      anguloTubular: req.body.anguloTubular,
      anguloMedida: req.body.anguloMedida,
    ...
    try {
      ...
      const duplicateAnjeoLight = await AnjeoHeavy.create({
        ...
        angleTubular: anjeoHeavyToDuplicate.anguloTubular,
        angleMeasure: anjeoHeavyToDuplicate.anguloMedida,
